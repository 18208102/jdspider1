...
a3 = lc.loc[lc["grade"] == "二级能效"].grade.count()
a0 = lc.loc[lc["grade"] == "一级能效"].grade.count()
a1 = lc.loc[lc["grade"] == "二级能效"].grade.count()
a2 = lc.loc[lc["grade"] == "三级能效"].grade.count()
